...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/akito/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/akito/.local/share/qutebrowser/userscripts/*')

# c.tabs.position = 'left'
# c.tabs.width = '3%'
c.url.start_pages = ["https://startpage.com/"]
c.url.default_page = 'https://ststartpage.com/'
